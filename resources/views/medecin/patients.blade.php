...
<head>
    ...
    <script src="{{ asset('js/medecin/medecin-patients.js') }}"></script>
</head>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Mes Patients</h1>
                        <p class="text-sm text-gray-600">Gérer mes patients</p>
                    </div>
                </div>
    ...
    <main class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6">
            ...
            <div id="no-patients" class="hidden text-center py-12">
                ...
                <p class="text-gray-500 font-medium">Aucun patient trouvé</p>
                <p class="text-sm text-gray-400 mt-2">Vous n'avez pas encore de patients qui ont pris rendez-vous avec vous</p>
            </div>
