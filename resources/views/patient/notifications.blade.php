...
<head>
    ...
    <script src="{{ asset('js/patient/patient-notifications.js') }}"></script>
</head>
<body class="bg-gradient-to-br from-purple-50 to-indigo-100 min-h-screen">
            ...
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Consulter mes notifications</p>
                    </div>
                </div>
    ...
    <main class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6">
            <h2 class="text-xl font-bold text-gray-900 mb-6">Notifications Reçues</h2>
            ...
            <div id="no-notifications" class="hidden text-center py-12">
                ...
                <p class="text-gray-500 font-medium">Aucune notification reçue</p>
                <p class="text-sm text-gray-400 mt-2">Vous n'avez pas encore reçu de notifications</p>
            </div>
